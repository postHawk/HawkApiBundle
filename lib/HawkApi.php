...
namespace Hawk\ApiBundle;
use Hawk\ApiBundle\Transport\HawkTransport;
use Hawk\ApiBundle\Transport\HawkTransportCurl;
use Hawk\ApiBundle\Transport\HawTransportSocket;
